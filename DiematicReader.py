...
class DiematicReader():
    ...
    def read(self):
        ...
        circuitA = DiematicCircuit(self.ir(18, 1), self.ir(14, 1), self.ir(15, 1), self.ir(16, 1), self.ir(17), self.ir(19))
        circuitB = DiematicCircuit(self.ir(27, 1), self.ir(23, 1), self.ir(24, 1), self.ir(25, 1), self.ir(26), self.ir(28), self.ir(33, 1))
        circuitC = DiematicCircuit(self.ir(39, 1), self.ir(35, 1), self.ir(36, 1), self.ir(37, 1), self.ir(38), self.ir(40), self.ir(45, 1))
